...
$arResult["CURRENCY"] = '&#x20bd;';
?>
<div class='bc-cart-w <?= (($arParams["BEE_VIEW_POSITION"] == 'LEFT') ? 'bc-cart-w--left' : '') ?>' id="<?= $blockId ?>" style="
             display: none;
        ...
        <div class="bc-cart-w-btn-show-cart-image-w">
            <div class="bc-cart-w-btn-show-cart-count-w">
                ...
                <div class="bc-cart-w-btn-show-cart-count__close">
                    <svg height="100%" width="100%" id="close" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style="
                ...
                <div class="bc-cart-w-btn-show-cart-count" style="
        ...
        <div class="basket">
            <div class="basket__title">
                <div class="basket__title__wrapper">
                    Корзина <span class="basket__title__wrapper-span"></span>
                </div>
            </div>
            ...
            <div class="basket__container">
                <div class="basket__all-item__remove" @click="removeAllItems">Очистить корзину</div>
            </div>
