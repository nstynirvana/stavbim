            ...
            <div class="row">
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    <div class="item__catalog__content-block-mobile-filter-main__smart <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box  <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
                        ...
                        <div class="item__catalog__content-block-mobile-filter-main__smart__title item__catalog-accord-title active" onclick="smartFilter.hideFilterProps(this)">
                        ...
                        <div class="item__catalog__content-block-mobile-filter-main__smart__descr item__catalog-accord-descr active" data-role="bx_filter_block">
                ...
                <div class="col-xs-12 bx-filter-button-box">
                    <div class="bx-filter-block">
                        <div class="bx-filter-parameters-box-container">
                            <button class="item__catalog__content-block-mobile-filter-main__accept" type="submit" id="set_filter" name="set_filter">
                                Применить фильтр
                            </button>
