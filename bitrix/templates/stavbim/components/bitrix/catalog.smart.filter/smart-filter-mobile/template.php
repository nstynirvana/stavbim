...
?>
<div class="<?= $templateData["TEMPLATE_CLASS"] ?> <? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal" ?>">
            ...
            <div class="row">
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    if (
                        ...
                        continue;
                    ?>
                    <div class="item__catalog__content-block-mobile-filter-main__smart <? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?>col-sm-6 col-md-4<? else: ?>col-lg-12<?endif ?> bx-filter-parameters-box  <? if ($arItem["DISPLAY_EXPANDED"] == "Y"): ?>bx-active<?endif ?>">

                        <div class="item__catalog__content-block-mobile-filter-main__smart__title item__catalog-accord-title active"
                            ...
                            <span data-role="prop_angle"
                                  class="fa fa-angle-<? if ($arItem["DISPLAY_EXPANDED"] == "Y"): ?>up<? else: ?>down<?endif ?>"></span>
                        </div>

                        <div class="item__catalog__content-block-mobile-filter-main__smart__descr item__catalog-accord-descr active"
                    ...
                    <div class="bx-filter-block">
                        <div class="bx-filter-parameters-box-container">
                            <button type="submit" id="set_filter" name="set_filter"
                                    class="item__catalog__content-block-mobile-filter-main__accept">
                                Применить фильтр
                            </button>
