...
<? $APPLICATION->IncludeComponent(
    "bitrix:news.list",
    "text-block-page-container-order",
    array(
        ...
        "PAGER_TITLE" => "Новости",
        "PARENT_SECTION" => "12",
        "PARENT_SECTION_CODE" => "o-razrabotke-semeystv",
        "PREVIEW_TRUNCATE_LEN" => "",
        "PROPERTY_CODE" => array("", "PICTURE_RIGHT"),
        "SET_BROWSER_TITLE" => "Y",
        "SET_LAST_MODIFIED" => "N",
        ...
        <div class="block__sort">
            ...
            <? $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "CACHE_TYPE" => "A",
                    "CHECK_DATES" => "Y",
                    "COMPONENT_TEMPLATE" => "myworks-page-catalog-order",
                    "DETAIL_URL" => "",
                    "DISPLAY_BOTTOM_PAGER" => "Y",
                    "DISPLAY_DATE" => "Y",
                    "DISPLAY_NAME" => "Y",
